...
#ifndef __GST_DSOSDCOORD_H__
#define __GST_DSOSDCOORD_H__
...
#define GST_TYPE_DSOSDCOORD \
  (gst_ds_osdcoord_get_type())
#define GST_DSOSDCOORD(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_DSOSDCOORD,GstDsOsdCoord))
#define GST_DSOSDCOORD_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_DSOSDCOORD,GstDsOsdCoordClass))
#define GST_IS_DSOSDCOORD(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_DSOSDCOORD))
#define GST_IS_DSOSDCOORD_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_DSOSDCOORD))
...
typedef struct _GstDsOsdCoord GstDsOsdCoord;
typedef struct _GstDsOsdCoordClass GstDsOsdCoordClass;

/**
 * GstDsOsdCoord element structure.
 */
struct _GstDsOsdCoord
{
  ...
  /** Pointer to the dsosdcoord context. */
  void *dsosdcoord_context;
  /** Enum indicating how the objects are drawn,
      i.e., CPU, GPU or VIC (for Jetson only). */
  NvOSD_Mode dsosdcoord_mode;
...
struct _GstDsOsdCoordClass
{
  GstBaseTransformClass parent_class;
};

GType gst_ds_osdcoord_get_type (void);

G_END_DECLS
#endif /* __GST_DSOSDCOORD_H__ */
